...
// Configurações de paginação e temporização
const VISITS_PER_PAGE = 4;
const BUTTON_WINDOW = 5 * 60 * 1000; // 5 minutos
    ...
    <>
      <div className="card-overlay" style={containerStyle}>
        ...
        <VisitTable
          ...
          onDelete={handleDelete} // Adicione esta linha
        />
      ...
      {/* Componentes modais fora do container principal */}
      <ConfirmModal
        title="Cancelamento"
        ...
        style={{ zIndex: 2000 }} // Garante que fique acima de tudo
      />
      ...
      {showSuccess && (
        <Notification
          ...
          autoCloseDelay={4000}
          style={{ zIndex: 2001 }} // Z-index maior que o modal
        />
      )}
    </>
  );
