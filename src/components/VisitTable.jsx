// src/components/VisitTable.jsx

import React from 'react';
import { Link } from 'react-router-dom';
import { FaEdit, FaTrash, FaCheckCircle } from 'react-icons/fa'; // Ícones do Font Awesome

/**
 * Componente: StatusBadge
 * @param {Object} props - Propriedades do componente.
 * @param {string} props.status - Status da visita.
 */
...
/**
 * Componente: VisitTable
 * @param {Object} props - Propriedades do componente.
 * @param {Array} props.visits - Array de visitas a serem exibidas.
 * @param {Function} props.onCancel - Função para cancelar uma visita.
 * @param {Function} props.onMarkAsDone - Função para marcar uma visita como realizada.
 */
